...
const PaymentMethod = () => {
  ...
  return (
    <Box sx={{ width: '100%', p: 4, my: 4, border: '1px solid #E5E7EB', borderRadius: 2, boxShadow: 2 }}>
      <div className="flex flex-col md:flex-row justify-between gap-6 align-center">
        <div className={`w-full md:w-2/3`}>
          <Typography variant="h4" component="h1" className={`text-lg font-bold mb-8`}>
            PAYMENT METHOD
          </Typography>
          <hr />
          ...
          <div className="mt-6">
            <Typography variant="subtitle3" className={`font-semibold mt-4 mb-4`}>
              Credit Card / Debit Card / Netbanking / UPI
            </Typography>
            <hr className="mb-2" />
            <Typography variant="body2" className="text-zinc-600 mb-6">
              You will be redirected to CCAvenue website when you place an order.
            </Typography>
          </div>
      ...
      <Box sx={{ borderTop: '1px solid #E5E7EB', py: 4, display: 'flex', justifyContent: 'center' }}>
        <Button
          variant="contained"
          sx={{ backgroundColor: '#EF4444', color: 'white', paddingX: 6, paddingY: 2 }}
