    ...
    <div className="flex flex-col-reverse md:flex-row justify-between border-2 p-4">
      ...
      <div className="md:w-[60%]">
        ...
        <form onSubmit={handleSubmit} className="mt-4">
          ...
          <div className="mb-4">
            <label className="block text-zinc-700">Street Address <span className="text-red-600">*</span></label>
            <input
              type="text"
              name="streetLine1"
              className="w-full border border-zinc-300 p-2"
          ...
          <div className="mb-4">
            <label className="block text-zinc-700">Postal Code <span className="text-red-600">*</span></label>
            <input
              type="text"
              name="postalCode"
              className="w-full border border-zinc-300 p-2"
